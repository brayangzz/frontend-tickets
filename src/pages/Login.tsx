...
export const Login = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // D) Redirigir al Home con reemplazo de historial
      navigate("/", { replace: true }); 
  ...
  return (
    <div className="flex min-h-screen w-full bg-slate-50 dark:bg-[#0f172a] text-slate-900 dark:text-white font-display overflow-hidden">
      ...
      <div className="hidden lg:flex w-1/2 relative items-center justify-center bg-[#0f172a] overflow-hidden border-r border-slate-800">
         ...
         <div className="absolute bottom-[-10%] right-[-10%] w-[500px] h-[500px] bg-purple-600/20 rounded-full blur-[120px] animate-pulse" style={{ animationDelay: "1s" }}></div>
         
         <div className="relative z-10 p-12 flex flex-col items-center text-center gap-6 max-w-lg">
            {/* LOGO EN BLANCO (Mismo aspecto y diseño, solo color) */}
            <motion.img 
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 relative bg-slate-50/50 dark:bg-[#0f172a]">
         ...
         >
            ...
            <div className="flex flex-col gap-2">
                ...
                <h2 className="text-3xl md:text-4xl font-extrabold tracking-tight">Iniciar Sesión</h2>
                <p className="text-slate-500 dark:text-slate-400 font-medium">Ingresa tus credenciales para acceder al sistema.</p>
            </div>
            ...
            <form onSubmit={handleLogin} className="flex flex-col gap-6" autoComplete="off">
                ...
                <div className="flex flex-col group space-y-2">
                    <label className="text-[11px] font-extrabold uppercase tracking-widest text-slate-500 dark:text-slate-400 ml-1 group-focus-within:text-blue-500 transition-colors">Usuario</label>
                    <motion.div 
                    ...
                    >
                        <span className="material-symbols-rounded absolute left-4 top-1/2 -translate-y-1/2 z-20 text-[22px] transition-colors duration-300 text-slate-400 dark:text-slate-500 group-focus-within:text-blue-500 pointer-events-none">person</span>
                        <input 
                            type="text" 
                            name="email"
                ...
                {/* INPUT CONTRASEÑA */}
                <div className="flex flex-col group space-y-2">
                    <label className="text-[11px] font-extrabold uppercase tracking-widest text-slate-500 dark:text-slate-400 ml-1 group-focus-within:text-blue-500 transition-colors">Contraseña</label>
                    <motion.div 
                        ...
                        className="relative w-full"
                    >
                        <span className="material-symbols-rounded absolute left-4 top-1/2 -translate-y-1/2 z-20 text-[22px] transition-colors duration-300 text-slate-400 dark:text-slate-500 group-focus-within:text-blue-500 pointer-events-none">lock</span>
                        <input 
